...
installTheme(){
    ...
    rm -r Utama
    git clone https://github.com/VynzzLoli/Utama.git
    cd Utama
...
repair(){
    bash <(curl https://raw.githubusercontent.com/VynzzLoli/Utama/main/repair.sh)
}
...
echo ""
echo "Wa: +63 831-2130-6468"
echo "Nama: VynzzOfficial"
echo ""
